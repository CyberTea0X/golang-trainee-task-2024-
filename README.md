...
вы можете выполнять запросы к сервису. Postman не всегда правильно интерпретирует
документацию openapi, поэтому некоторые запросы придётся подправить.

Вы можете обращаться к сервису через curl. 
